      ...
      <div className="mkt-page">
        ...
        <nav className="mkt-nav">
          ...
          <div className="mkt-nav-links">
            ...
            <a href="https://outcome-ready.vercel.app" target="_blank" style={{color:'#4a7c59',fontWeight:700}}>🌿 OutcomeReady</a>
        ...
        <section className="mkt-hero">
          <div className="mkt-hero-left">
            <h1>Reading books customised to your child. AI-powered. Always adapting.</h1>
            <p>Reading Buddy doesn't lock you into one book series. Upload your own books, use PM Readers, Oxford, or anything your child loves — the AI adapts the experience to them, not the other way around. Safe, distraction-free, and built for ages 5–12.</p>
        ...
        <footer className="mkt-footer">
          ...
          <p style={{ fontSize: '0.8rem' }}>Tech 4 Humanity Pty Ltd · <a href="https://outcome-ready.vercel.app" style="color:#4a7c59">OutcomeReady</a> · ABN 70 666 271 272 · Built in Australia 🇦🇺</p>
